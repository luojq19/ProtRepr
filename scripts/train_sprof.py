...
from datasets.sequence_dataset import SequenceDataset, SingleLabelSequenceDataset, SingleLabelHierarchyDataset
from models.mlp import MLPModel
from models.sprof_model import SprofECModel
...
def main():
    ...
    model = SprofECModel(config.model)
